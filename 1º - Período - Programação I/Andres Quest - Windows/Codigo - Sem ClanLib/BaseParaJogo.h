...
O primeiro parametro eh um numero inteiro que identifica
unicamente a figura a ser desenhada.
*/
...
Um dos formatos permitidos eh WAV.
Retorna um numero inteiro que identifica unicamente o som carregado
*/
int carregaSom(const char *nomeArq);


/*
Inicia a execucao de um som previamente carregado.
O primeiro parametro eh um numero inteiro que identifica
unicamente o som a ser executado.
O segundo parametro indica se o som deve ser tocado repetidamente em loop.,
por exemplo, como musica de fundo.
*/
void iniciaSom(int numSom, bool loop = false);


/*
Continua a execucao de um som que havia sido parado anteriormente.
O parametro eh um inteiro que identifica unicamente o som a ser continuado.
*/
void continuaSom(int numSom);


/*
Interrompe a execucao de um som que estava sendo executado.
O parametro eh um inteiro que identifica unicamente o som a ser parado
*/
