	...
	<?php
		if(isset($newProduto)){
			if($newProduto){
				...
				echo"<script type='text/javascript'>";
				echo "alert('Não foi possível cadastrar o produto!');";
				echo "</script>";
			}
		}
	?>
...
if(isset($_SESSION['tipo']) && $_SESSION['tipo'] == 'loja') {
	...
	echo '<li class="current-menu-item"><a href="registerProducts.php">CADASTRAR PRODUTO</a></li>';
...
?>
		...
		<div id="main">
        	...
        	<div id="page-content" class="cf">        	
				...
				<p><h3>CADASTRAR PRODUTOS</h3></p>
				<!-- form -->
				<script type="text/javascript" src="js/form-validation.js"></script>
				<form id="contactForm" action="insertProducts.php" method="post">
					<fieldset>
						...
						<p>
							...
							<input name="description"  id="description" type="text" class="form-poshytip" size="20" />
						</p>
						
						<p>
						
							<label for="value" >Valor</label>
							<input name="value"  id="value" type="text" class="form-poshytip" />
						</p>
						<p>
...
<?php
	...
	while ($aux = mysqli_fetch_array($ListarCategorias))
		echo '<option value="'.$aux['idCategoria'].'"> '.$aux['nome'];
...
?>						
						...
						<p>
							...
							<input name="stock"  id="stock" type="number" class="form-poshytip" min="0" size="2"/>
						</p>
						
						<p>
	
						<p>
							<label for="imagi">Foto do produto</label>
							<input name="imagi"  id="imagi" type="text" class="form-poshytip" />
						</p>
