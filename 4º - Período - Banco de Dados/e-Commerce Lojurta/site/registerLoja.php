	...
	<?php
		if(isset($newStore)){
			if($newStore){
				...
				echo "alert('Loja cadastrada com sucesso!');";
				echo "</script>";
			}
			else{
				echo"<script type='text/javascript'>";
				echo "alert('Não foi possível fazer o cadastro da loja!');";
				echo "</script>";
			}
		}
	?>
...
?>
		...
		<div id="main">
        	...
        	<div id="page-content" class="cf">        	
				...
				<p><h3>CADASTRAR LOJA</h3></p>
				<!-- form -->
				<script type="text/javascript" src="js/form-validation.js"></script>
				<form id="contactForm" action="insertStore.php" method="post">
					<fieldset>
														
						<p>
							<label for="name" >Nome da loja</label>
							<input name="name"  id="name" type="text" class="form-poshytip" title="Digite o nome da loja" />
						</p>
						
						<p>
							<label for="description">Descrição</label>
							<input name="description"  id="description" type="text" class="form-poshytip" title="Breve descrição da loja" size="20" />
						</p>
						
						<p>
							<label for="CNPJ" >CNPJ</label>
							<input name="CNPJ"  id="CNPJ" type="text" class="form-poshytip" title="Digite o CNPJ da loja" />
						</p>
						
						<p>
							<label for="password" >Senha</label>
							<input name="password"  id="password" type="text" class="form-poshytip" title="Digite a senha da Loja" />
						</p>
						
						<p>
							<label for="web">Website</label>
							<input name="web"  id="web" type="text" class="form-poshytip" title="Digite o website da loja" />
						</p>
						
						<p>
							<label for="imagi" >Link Imagem</label>
							<input name="imagi"  id="imagi" type="text" class="form-poshytip" title="Link da imagem" />
						</p>
